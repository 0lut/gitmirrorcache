...
ECS_ALB_HEALTH_CHECK_INTERVAL_SECONDS="${ECS_ALB_HEALTH_CHECK_INTERVAL_SECONDS:-10}"
...
export ECR_PUSH_LATEST ECS_SKIP_DOCKER_BUILD_IF_IMAGE_EXISTS ECS_EBS_DELETE_ON_TERMINATION
