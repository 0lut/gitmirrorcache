...
GIT_CACHE_DISK_QUOTA_BYTES="${GIT_CACHE_DISK_QUOTA_BYTES:-$((ECS_EBS_SIZE_GIB * 1024 * 1024 * 1024 - GIT_CACHE_DISK_MIN_FREE_BYTES))}"
...
export ECS_INSTANCE_NAME ECS_CPU ECS_MEMORY ECS_DESIRED_COUNT ECS_EC2_INSTANCE_TYPE
